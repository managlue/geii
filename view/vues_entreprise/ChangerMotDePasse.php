...
try {
    ...
    $stmt = $pdo->prepare("SELECT id_entreprise FROM entreprise WHERE id_entreprise = :id");
    ...
    if ($rowCount == 0) {
        ...
        if (isset($_POST['pwd_inscription']) && isset($_POST['confirm_pwd'])) {
            ...
            if ($newPassword === $confirmPassword) {
                ...
                $updateStmt = $pdo->prepare("UPDATE entreprise SET pswd_entreprise = :pwd_inscription WHERE id_entreprise = :id");
