...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 09 juin 2023 à 17:42
...
--
-- Base de données : `id20742082_geii`
--
...
(2, 'Bourgeois', 'Corentin', 'coco', 'coco', NULL);
...
INSERT INTO `etudiant` (`id_etudiant`, `nom_etudiant`, `prenom_etudiant`, `login_etudiant`, `pswd_etudiant`, `id_classe`) VALUES
(7, 'Bourgeois', 'Corentin', 'cbo', 'AzertY12', 2),
(8, 'Croti-Hem', 'Marco', 'mcr', 'QsdfgH34', 1);
...
INSERT INTO `note` (`id_note`, `note`, `intitule`, `coefficient`, `commentaire`, `id_etudiant`, `id_matiere`, `id_enseignant`) VALUES
(241, 15, 'QCM', 1, 'TB', 7, 1, 1);
...
CREATE TABLE IF NOT EXISTS `offre_alternance` (
  ...
  `description_entr` text COLLATE utf8mb3_unicode_ci,
